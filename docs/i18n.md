...
Don't use class components, use [hooks](https://reactjs.org/docs/hooks-overview.html) instead. If you still have a class component and want to provide `t` function to it, look at a [legacy documentation](./i18n-legacy.md).
