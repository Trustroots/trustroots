...
ARG TRUSTROOTS_BUILD_BRANCH

ENV TRUSTROOTS_BUILD_COMMIT=${TRUSTROOTS_BUILD_COMMIT} \
  TRUSTROOTS_BUILD_COMMITTED_AT=${TRUSTROOTS_BUILD_COMMITTED_AT} \
  TRUSTROOTS_BUILD_BRANCH=${TRUSTROOTS_BUILD_BRANCH}
