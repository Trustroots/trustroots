        ...
        <div className="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
          <ul>
            ...
            <li>
              ...
              <p>
                <Trans>
                  Use the website: travel and host! Test it out with different mobile devices, browsers, and screen sizes. Report bugs by opening <a href="https://github.com/Trustroots/trustroots/issues/new">an issue on GitHub</a> or use the <a ui-sref="contact">contact</a> form.
                </Trans>
              </p>
            </li>
            ...
            <li>
              ...
              <p><Trans>We&apos;re always happy to <a ui-sref="contact">hear from you</a> if you don&apos;t know what you can do.</Trans></p>
