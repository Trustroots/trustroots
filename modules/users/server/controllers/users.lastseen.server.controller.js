...
module.exports = function (req, res, next) {
  ...
  if (req.user) {
    ...
    const expectedTimeToPass = moment.duration(config.limits.timeToUpdateLastSeenUser).asMilliseconds();
    const isTimePassed = !req.user.seen || Date.now() - req.user.seen.getTime() > expectedTimeToPass;
    if (isTimePassed) {
