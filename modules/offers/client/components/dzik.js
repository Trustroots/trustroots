...
//       updatedState.isOwnOffer = (authUser && authUser._id && authUser._id === profile._id);
//       updatedState.isUserPublic = (authUser && authUser.public);
//       this.setState(() => ({
//         cats: true
//       }))
...
//             const off = offers[0]
//             updatedState.offer = off;
//             updatedState.isLoading = false;
//             that.setState(() => {return updatedState}, console.log('STATE INSIDE CB', this.state));
