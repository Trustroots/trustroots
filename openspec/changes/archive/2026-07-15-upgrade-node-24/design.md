...
- Treat the client migration as part of the runtime-platform capability itself.
  The coordinated `hybrid-react-shell-on-node-24` change documents the
  AngularJS removal, React 18 upgrade, and router architecture delivered in the
  same pull request.
