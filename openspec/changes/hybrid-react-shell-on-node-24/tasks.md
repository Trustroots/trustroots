...
- [x] 2.5 Upgrade to React 18 and `createRoot`; adopt TanStack Router for route
      matching, parameters, search state, navigation, and rendering.

## 3. Stage 3 — Bootstrap 5

- [ ] 3.1 Deferred out of PR 2769 (keep Bootstrap 3 / react-bootstrap 0.33).
- [ ] 3.2 Adapt global Less/Sass imports and local Bootstrap overrides in a
      follow-up change.
- [ ] 3.3 Fix renamed/removed Bootstrap 3 classes and component APIs in that
      follow-up change.
